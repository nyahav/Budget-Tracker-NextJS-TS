import {  Yad2RealEstateItem} from "../types/yad2/yad2-real-estate-item"
import {Yad2AdvertisementItem} from "../types/yad2/yad2-advertisemnt-item";
import { Yad2RealEstateResponse } from "../types/yad2/yad2-real-estate-response";
import { RealEstate } from "../types/real-estate"; // Assuming RealEstate type is now in types, not dtos.
